...
This section guides you through submitting a bug report for WIGOC. **Following these guidelines** helps maintainers and the community...
...
1. Perform a cursory search [here](https://github.com/gongahkia/wigoc/issues) for whether the issue has already been reported.
...
This section guides you through submitting an enhancement suggestion for WIGOC. **Following these guidelines** helps maintainers and the community...
...
1. Perform a cursory search [here](https://github.com/gongahkia/wigoc/issues) for whether the enhancement has already been suggested.
...
Unsure where to begin contributing to WIGOC? You can start by looking through these beginner and help-wanted issues:

* [Beginner issues](https://github.com/gongahkia/wigoc/labels/good%20first%20issue): Issues which should only require a few lines of code, and a test or two.
* [Help wanted issues](https://github.com/gongahkia/wigoc/labels/help%20wanted): Issues which should be a bit more involved than beginner issues.
